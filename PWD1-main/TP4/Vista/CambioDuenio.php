...
<div class="container-sm p-4">
    ...
    <form name=CambioDuenio id=CambioDuenio method=post action="./accion/accionCambioDuenio.php" autocomplete=off novalidate class="row g-3">
        ...
        <div class="col-md-6">
            <input name=buscar id=buscar type=submit value="Registrar" class="btn btn-outline-info">
        </div>
