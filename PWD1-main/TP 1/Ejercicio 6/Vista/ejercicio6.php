...
<body>
  <div class="container p-3">
    <div class="border bg-light border-3 rounded p-2 mt-3">
      <h4>Ejercicio 6</h4>
      <form method="get" action="../Control/frasedeporte.php" id="form4">
        <div class="row mb-3">
          <div class="col">
        ...
        <div class="row mb-3">
          <div class="col">
            <p>Seleccione los deportes que realiza:</p>
            <div class="form-group" id="deportes_checkbox_group">
              <div class="form-check form-check-inline">
                <input
                  class="form-check-input"
                  type="checkbox"
              ...
              <div class="form-check form-check-inline">
                <input
                  ...
                  id="basket"
                />
                <label class="form-check-label" for="basket"> Básket </label>
              </div>
              <div class="form-check form-check-inline">
                <input
                  class="form-check-input"
